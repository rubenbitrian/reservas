...
// Password: 1234
// Password-hash: $2y$13$Jmaqlq10jGku4gd7zdegzOtzNc964vLA6KW8td2xnaVdfDnrCKGKO
...
final class Version20210914092625 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, user_group_id INT DEFAULT NULL, nombre VARCHAR(180) NOT NULL, apellidos VARCHAR(200) NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D6491ED93D47 (user_group_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
